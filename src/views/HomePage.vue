<template>
  ...
  <a-card class="headCard">
    <div class="homePage">
        <div class="content" @click="btnTask">
          <img class="contentImg1" src="../../static/img/1.png" >
          <span>巡检任务</span>
        </div>
        <div class="content" @click="btnRepair">
          <img class="contentImg2" src="../../static/img/2.png" >
          <span>报修记录</span>
        </div>
        <div class="content" @click="btnRemind">
          <img class="contentImg3" src="../../static/img/3.png" >
          <span>效期提醒</span>
        </div>
    </div>
  </a-card>
...
export default {
  methods: {
    ...
    btnRepair () {
      this.$router.push({path: '/business/bizRepairRecord'})
    },
    btnRemind () {
      this.$router.push({path: '/business/bizValidityRemind'})
    }
  }
}
</script>
